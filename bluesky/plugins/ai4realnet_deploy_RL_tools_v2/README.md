# AI4REALNET RL deployment plug-in with randomly generated scenarios and perturbations v2
...
Choose which environment you would like to test, uncomment it inside the scenario file `ai4realnet_deploy_RL_randomised_scenario_loading_v2.scn`.

Load the scenarios called `ai4realnet_deploy_RL_randomised_scenario_loading_v2.scn` contained in `scenario/ai4realnet_deploy_RL_randomised_scen_loading_v1-2/`
...
bluesky/
└── plugins/
    ├── ai4realnet_deploy_RL_randomised_scenario_v2.py
    └── ai4realnet_deploy_RL_tools_v2
        ├── ai4realnet_perturbations_v0.py
        └── ai4realnet_random_scenario_generator_v0.py
...
└── ai4realnet_deploy_RL_randomised_scen_loading_v1-2/
    ├── ai4realnet_deploy_RL_randomised_scenario_loading_v2.scn
    ├── config_screen.scn
    ├── sector.scn
    └── generated_scenarios/
```
