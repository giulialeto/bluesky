...
class ScenarioGenerator(core.Entity):  
    ...
    def _generate_random_aircraft(self, n_ac, sector_name, obstacle_names, latitude_bounds, longitude_bounds):
        ...
        while np.isnan(lat_orig).any():
            ...
            # print(f'inside_sector: {inside_sector}')
            inside_any_restricted = np.zeros_like(inside_sector, dtype=bool)
            # print(f'inside_any_restricted: {inside_any_restricted}')
            ...
            for name in obstacle_names:
                ...
                # print(f'inside_restricted: {inside_restricted_area}')
        ...
        while np.isnan(lat_dest).any():
            ...
            for name in obstacle_names:
                ...
                # print(f'inside_restricted_area: {inside_restricted_area}, lat_try: {lat_try}, lon_try: {lon_try}, altitude: {altitude} ')
                inside_any_restricted |= inside_restricted_area
                # print(f'inside_any_restricted: {inside_any_restricted}')
