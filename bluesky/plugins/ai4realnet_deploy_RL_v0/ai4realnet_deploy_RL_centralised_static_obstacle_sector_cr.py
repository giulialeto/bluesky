"""
    ...
    ENV: CentralisedStaticObstacleSectorCREnv-v0
    Authors: Giulia Leto
"""
from bluesky import core, stack, traf, tools, settings 
from stable_baselines3 import SAC
import numpy as np
import bluesky.plugins.ai4realnet_deploy_RL_tools_v0.CentralisedStaticObstacleSectorCREnv as RLtools
...
def init_plugin():
    CentralisedStaticObstacleSectorCR = DeployRL()
    # Configuration parameters
    config = {
        # The name of your plugin
        'plugin_name':     'DEPLOY_RL_CentralisedStaticObstacleSectorCREnv',
...
class DeployRL(core.Entity):  
    ...
    def _get_obs(self):
        ...
        for point_index in range(len(self.sector_points)):
            sector_points_qdr, sector_points_dis = bs.tools.geo.kwikqdrdist(bs.traf.lat, bs.traf.lon, self.sector_points[point_index,0],self.sector_points[point_index,1])
